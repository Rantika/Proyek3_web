                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tambah Booking
                                <a href="{{url('admin/booking')}}" class="float-right btn btn-success btn-sm">Lihat</a>
                            </h6>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <form method="post" enctype="multipart/form-data" action="{{url('admin/booking')}}">
                                    ...
                                    <table class="table table-bordered" >
                                        <tr>
                                            <th>Pilih Customer <span class="text-danger">*</span></th>
                                            <td>
                                        ...
                                        <tr>
                                            <th>
                                                Kamar yang Tersedia <span class="text-danger">*</span></th>
                                            <td>
