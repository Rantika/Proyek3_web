    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Indramayu Hotel</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="bannerSection" class="collapse @if(request()->is('admin/banner')) show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('admin/banner/create')}}">Tambah</a>
                        <a class="collapse-item" href="{{url('admin/banner')}}">Lihat</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse @if(request()->is('admin/roomtype*')) show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('admin/roomtype/create')}}">Tambah</a>
                        <a class="collapse-item" href="{{url('admin/roomtype')}}">Lihat</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="roomMaster" class="collapse @if(request()->is('admin/rooms*')) show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('admin/rooms/create')}}">Tambah</a>
                        <a class="collapse-item" href="{{url('admin/rooms')}}">Lihat</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="CustomerMaster" class="collapse @if(request()->is('admin/customer*')) show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('admin/customer/create')}}">Tambah</a>
                        <a class="collapse-item" href="{{url('admin/customer')}}">Lihat</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="DepartmentMaster" class="collapse @if(request()->is('admin/department*')) show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('admin/department/create')}}">Tambah</a>
                        <a class="collapse-item" href="{{url('admin/department')}}">Lihat</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="StaffMaster" class="collapse @if(request()->is('admin/staff*')) show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('admin/staff/create')}}">Tambah</a>
                        <a class="collapse-item" href="{{url('admin/staff')}}">Lihat</a>
                    </div>
                </div>
            </li>
